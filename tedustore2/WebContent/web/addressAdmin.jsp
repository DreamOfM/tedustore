   ...
   <!-- 右边栏-->
    <div class="rightsidebar_box rt">	
        ...
        <div class="rs_content">
        	<form name =" f1" method="post" action="../address/addAddress.do">
	            <!--收货人姓名-->
	            ...
	            <div data-toggle="distpicker" class="address_content">
					 ...
					 <select data-province="---- 选择省 ----" id="receiverState" name="receiverState" ></select>
            ...
            <!--已有地址栏-->
             ...
             <div class="address_information_manage">
                ...
                <c:forEach items="${addresses}" var="a" varStatus="s">
                
                 <div class="aim_content_one aim_active">
                    <span class="dzmc dzmc_active">${a.recvTag}</span>
                    <span class="dzxm dzxm_normal">${a.recvName}</span>
                    <span class="dzxq dzxq_normal">${a.recvDistrict} ${a.recvAddr}北京市海淀区北下关街道中鼎大厦B座331</span>
                    <span class="lxdh lxdh_normal">${a.recvPhone}</span>
                    <span class="operation operation_normal">
                    <input type="hidden" name="aid" value="${a.id}"> 
                    	<span class="aco_change">修改</span>|<span class="aco_delete" id="${a.id}">删除</span>
                    </span>
