...
<div class="lf1">
    ...
    <div class="lf1_bottom">
        ...
        <c:forEach items="${list1FGoods}" var="goods">
    ...
    <div class="lf1_top">
        ...
        <div class="left lf">
            <div class="left_ys1 lf">
            	<img src="${pageContext.request.contextPath}/images/itemCat/study_stationery_img1.png" alt=""/>
            </div>
    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all item_color">
                <c:forEach items="${list2F}" var="gc" varStatus="s">
	                <p>${gc.name}</p>
	                <ul>
		                <c:forEach items="${list2FSubs[s.index]}" var="goodsCategory">
		                    <li>
		                    	<a href="${pageContext.request.contextPath}/goods/showGoods.do?categoryId=${goodsCategory.id}">
		                    		${goodsCategory.name}
		                    	</a>
        ...
        <c:forEach items="${list2FGoods}" var="goods">
	        <div class="item_msg lf" onclick='itemInfo(${goods.id},${goods.categoryId})'>
	            <img 
	            height="140px"
	            width="200px"
