...
<div id="container" class="clearfix">
   ...
   <jsp:include page="left.jsp"></jsp:include>
    ...
    <div class="rightsidebar_box rt">
        <div class="rs_header">
            <span class="rs_header_active"><a href="${pageContext.request.contextPath}/user/showPerson.do">我的信息</a></span>
            <span><a href="${pageContext.request.contextPath}/user/showPassword.do">安全管理</a></span>
        </div>

        <!--个人信息具体内容 -->
        <form action="" id="form-person" method="POST">
        <div class="rs_content">
            ...
            <div class="rs_content_username">
                ...
                <input class="ed_username" value="${user.username}" style="display: none;" name="username" id="username"/>
            ...
            <div class="rs_content_sex">
                ...
                <span class="man selected">
                	<input type="radio" name="gender" <c:if test="${user.gender==1}"> checked="checked"</c:if> value="1" id="gender">
                    <!-- <img src="../images/personage/select.png" alt=""/> -->男
                </span>
                <span class="women">
                	<input type="radio" name="gender" <c:if test="${user.gender==0}"> checked="checked"</c:if> value="0" id="gender">
...
$("#save").click(function() {
	  $.ajax({
	       	 "url":"${pageContext.request.contextPath}/user/updateParson.do",
	       	 "type":"POST",
	       	 "data":$("#form-person").serialize(),
	       	 "dataType":"json",
	       	 "success":function(json){
	       		 if (json.state == 1) {
	       			 window.location="${pageContext.request.contextPath}/user/showPerson.do";
	   			}else{
...
$(function() {
       ...
       $("#leftsidebar_box .count_managment img").attr("src","${pageContext.request.contextPath}/images/myOrder/myOrder2.png");
})
